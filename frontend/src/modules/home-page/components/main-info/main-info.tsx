				...
				<Grid container spacing={5}>
					...
					<Grid item xs={12} md={4}>
						<div className={classes.item}>
							...
							<Typography variant="subtitle1">
								{'Убеги от реальности и привычных шумных тусовок, окунувшись в мир живой музыки и родных людей вокруг.'}
							</Typography>
						</div>
					</Grid>
					<Grid item xs={12} md={4}>
						<div className={classes.item}>
							...
							<Typography variant="subtitle1">
								{'Стань организатором концерта маленького исполнителя в твоем городе, создавай настроение и осуществляй мечты.'}
							</Typography>
						</div>
					</Grid>
				</Grid>
